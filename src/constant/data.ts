        ...
        description: [
          {
            ...
            content: [
              "첫 프론트 엔지니어이자 유일한 프론트엔지니어로 기업 금융의 자금관리/자금조달을 도와 기업의 성장을 도와주는 CLOBE(구 레베뉴마켓)의 초기 구축/설계/개발/운영을 담당했습니다.",
              "팀에 도움이 되는일이라면, 개발 뿐 아니라 figma를 활용한 디자인/협업 방식 정립 등에 힘쓰기도 했고, 어떻게하면 효율적으로 일을 하며 팀이 만들어 가는 프로덕트 및 방향성에 도움을 줄 수 있을지 고민하며 <a href='https://medium.com/verticah/%EC%B2%AB%EB%B2%88%EC%A7%B8-%ED%94%84%EB%A1%A0%ED%8A%B8%EC%97%94%EB%93%9C-%EC%97%94%EC%A7%80%EB%8B%88%EC%96%B4-%EB%A1%9C-%ED%95%A9%EB%A5%98%ED%95%98%EB%A9%B4-%EC%96%B4%EB%96%A4-%EC%9D%BC%EB%93%A4%EC%9D%84-%ED%95%B4%EC%95%BC%ED%95%A0%EA%B9%8C-78c7d891e3a5'>이를 위한 노력</a>들을 하기도 했습니다.",
              "기능 개발뿐만 아니라 성능 최적화에도 힘썼고, 서비스 Light house 성능 점수를 64점에서 90점으로 올렸으며 서비스 내 주요액션(재무데이터 라벨링)의 INP(Interaction to Next Paint)를 CPU 성능 4분의 1 기준의 디바이스라 가정했을때 1.5초~4초에서 360ms ~ 540ms정도로 줄였습니다.",
            ],
          },
        ],
      },
