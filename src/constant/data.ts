        ...
        description: [
          {
            ...
            content: [
              ...
              "기능 개발뿐만 아니라 성능 최적화에도 힘썼고, 서비스 Light house 성능 점수를 64점에서 90점으로 올렸고 서비스 내 주요액션(재무데이터 라벨링)의 INP를 CPU 성능 4분의 1 기준의 디바이스라 가정했을때 1.5초~4초에서 360ms ~ 540ms정도로 줄였습니다.",
            ],
          },
        ],
      },
